...
namespace ctvscript {
  namespace AST {
     ...
     */
    namespace keyword {
      #include "nodes/keyword/var.h"
      class Var;	//: AST::node{};

      #include "nodes/keyword/fun.h"
      class Fun;	//: AST::node{};

      #include "nodes/keyword/if_else.h"
      class If;		//: AST::node{}; 
      class Else;	//: AST::node{}; 

      #include "nodes/keyword/return.h"
      class Return;	//: AST::node{};

      #include "nodes/keyword/typedef.h"
      class Typedef;	//: AST::node{};

      #include "nodes/keyword/import.h"
      class Import;	//: AST::node{};

      #include "nodes/keyword/class.h"
      class Namespace;
      class Class;
      class Public;
      class Private;
     ...
     */
    namespace symbol {
      #include "nodes/symbol/reference_symbol.h"
      class Reference;

      #include "nodes/symbol/semicolon.h"
      class Semicolon;	 //: AST::node{};

      #include "nodes/symbol/colon.h"
      class Colon;	 //: AST::node{};

      #include "nodes/symbol/comma.h"
      class Comma;

      #include "nodes/symbol/parenthesis.h"
      class Bparenthesis;//: AST::node{};
      class Eparenthesis;//: AST::node{};

      #include "nodes/symbol/brackets.h"
      class Bbracket;	 //: AST::node{};
      class Ebracket;	 //: AST::node{};

      #include "nodes/symbol/squarebrackets.h"
      class Bsqbracket; //: AST::node{};
      class Esqbracket; //: AST::node{};

      #include "nodes/symbol/star.h"
      class Star;	//: AST::node{};
    };
     ...
     */
    namespace operands {
      #include "nodes/operands/scope_resolution.h"
      class ScopeResolution;

      #include "nodes/operands/allocators_operands.h"
      class New;	 //: AST::node{};
      class Delete;	 //: AST::node{};

      #include "nodes/operands/binary_operators.h"
      class Binary_and;	 //: AST::node{};
      class Binary_or;	 //: AST::node{};
      class Binary_left_shift;	 //: AST::node{};
      class Binary_right_shift;	 //: AST::node{};

      #include "nodes/operands/assignement.h"
      class Assignement;

      #include "nodes/operands/mathematical_operators.h"
      ...
      #include "nodes/operands/comparison.h"
      class Or;			//: AST::node{};
      class And;		//: AST::node{};

      #include "nodes/operands/bool_operators.h"
     ...
     */
    namespace values {
      #include "nodes/values/types_modifier.h"
      class Const;
      class Static;

      #include "nodes/values/unspecified_typeid.h"
      class Unspecified_typeid;	 //: AST::node{};

      #include "nodes/values/string_litteral.h"
      class String;
      class Char;

      #include "nodes/values/floating.h"
      class Floating;

      #include "nodes/values/integer.h"
      class Integer;
     ...
     */
    namespace final {
      #include "nodes/final/scoped_id.h"
      class ScopedId;

      #include "nodes/final/scoped_type.h"
      class ScopedType;

      #include "nodes/final/function_prototype.h"
      class FunctionPrototype;

      #include "nodes/final/function_forward_declaration.h"
      class FunctionForwardDeclaration;

      #include "nodes/final/type_definition.h"
      class Type;

      #include "nodes/final/argumentList.h"
      class ArgumentsList;
    }
